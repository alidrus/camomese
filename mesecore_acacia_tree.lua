...
minetest.register_node("camomese:mesecore_acacia_tree", {
	...
	tiles = {"camomese_mesecore_acacia_tree_top.png", "camomese_mesecore_acacia_tree_top.png", "camomese_mesecore_acacia_tree.png"},
...
minetest.register_node("camomese:mesecore_acacia_tree_on", {
	paramtype2 = "facedir",
	tiles = {"camomese_mesecore_acacia_tree_top_on.png", "camomese_mesecore_acacia_tree_top_on.png", "camomese_mesecore_acacia_tree_on.png"},
	is_ground_content = false,
	groups = {tree = 1, choppy = 2, oddly_breakable_by_hand = 1, flammable = 2},
