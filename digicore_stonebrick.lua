...
-- Register the Digiline Core Stone Brick (off state) node
minetest.register_node("camomese:digicore_stonebrick", {
    description = S("Digiline Core Stone Brick"),
    tiles = {"camomese_digicore_stone_brick.png"},
	is_ground_content = false,
	inventory_image = minetest.inventorycube("camomese_digicore_stone_brick.png"),
